    ...
    return WidgetbookUseCase(
        ...
        ElevatedButton.icon(
          ...
          padding: MaterialStateProperty.all(EdgeInsets.only(
              top: context.knobs.slider(label: "verticalPading",initialValue: 14,description: "Merubah ukuran padding vertikal",min: 10,max: 50),
              bottom: context.knobs.slider(label: "verticalPading",initialValue: 14,description: "Merubah ukuran padding vertikal",min: 10,max: 50),right: 15,left: 8)),
          ...
          onPressed: () {},
          label: MCText(
            text: context.knobs.text(initialValue: "Example Button",label: "label",description: "Berfungsi untuk membuat label pada tombol"),
  ...
  WidgetbookUseCase outlineButton() {
    return WidgetbookUseCase(
        ...
        builder: (context) => OutlinedButton.icon(
          ...
          onPressed: () {},
          label: Text(context.knobs.text(initialValue: "Example Button",label: "label",description: "Berfungsi untuk membuat label pada tombol"),
