...
class DropdownStlyer {
  ...
  WidgetbookUseCase dropdownBook(){
    return WidgetbookUseCase(name: "MECDropdown", builder: (p0) => 
       PopupMenuItem(
        ...
        child: Column(
              ...
              children: <Widget>[
                ...
                ...getData(dataCount: p0.knobs.slider(label: "data",description: "Untuk mengeteahui apakah sedang kosong atau tidak",min: 0,max: 5,initialValue: 0).toInt()),
                GestureDetector(
                  onTap: () {
